...
func (s *articleBodyStub) Load(context.Context, api.Source, collector.FeedArticle) (string, error) {
	return s.body, nil
}
...
func (s *selectedFeedStub) Fetch(_ context.Context, source api.Source) (collector.Document, error) {
