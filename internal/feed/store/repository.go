...
var _ collector.Repository = (*Repository)(nil)
...
func (r *Repository) SaveArticle(ctx context.Context, source api.Source, article collector.FeedArticle, day string) error {
...
func publishedTimestamp(article collector.FeedArticle, fallbackDay string) string {
	parsed, valid := article.PublishedTime()
	if !valid {
