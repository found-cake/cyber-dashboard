(() => {
  ...
  const TEXT = {
    ko: {
      ...
      monthCumulative: "월간 누적 기준", recentCVEs: "최근 언급된 CVE",
    ...
    en: {
      ...
      monthCumulative: "Monthly cumulative", recentCVEs: "Recently mentioned CVEs",
    ...
    api("GET", "/api/dashboard").done(data => {
      ...
      $("#main-content").html(`<div class="content stack">
        ...
        <div class="dashboard-grid">
          <section class="card"><div class="card-header"><div><h2>${esc(t("attackMethods"))}</h2><p class="card-subtitle">${esc(t("articleClassified"))}</p></div></div>${barsHTML(data.attack_methods, true)}</section>
