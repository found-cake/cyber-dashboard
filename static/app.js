(() => {
  ...
  const TEXT = {
    ko: {
      ...
      cveExplorerHint: "CVSS + 언급수 × 0.2 기준 내림차순", cveScrollHint: "좌우로 스크롤하여 전체 열을 확인하세요.", rank: "순위", riskScore: "정렬 점수", entries: "개", backToDashboard: "대시보드로 돌아가기", noData: "아직 수집된 데이터가 없습니다",
    ...
    en: {
      ...
      cveExplorerHint: "Ranked by CVSS + mentions × 0.2", cveScrollHint: "Scroll horizontally to view every column.", rank: "Rank", riskScore: "Rank score", entries: "entries", backToDashboard: "Back to dashboard", noData: "No collected data yet",
  ...
  function renderCVEExplorer() {
    ...
    const renderRows = data => {
      ...
      $("#main-content").html(`<div class="content stack">
        <section class="card cve-page-summary"><div><span class="badge badge-info">${cves.length} ${esc(t("entries"))}</span><p class="card-subtitle">${esc(t("cveExplorerHint"))}</p></div><a class="secondary-button cve-back-link" href="#">${esc(t("backToDashboard"))}</a></section>
